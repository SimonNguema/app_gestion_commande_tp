            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="datetime-local" name="date_commande"
                           value="{{ old('date_commande', \Carbon\Carbon::parse($commande->date_commande)->format('Y-m-d\TH:i')) }}"
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="quantite" value="{{ old('quantite', $commande->quantite) }}" min="1"
                ...
                <div class="col-md-6">
                    ...
                    <select name="produit_id" class="form-select @error('produit_id') is-invalid @enderror" required>
                        ...
                        @foreach($produits as $produit)
                            <option value="{{ $produit->id }}" {{ old('produit_id', $commande->produit_id) == $produit->id ? 'selected' : '' }}>
